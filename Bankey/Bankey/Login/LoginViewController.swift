...
//    func didLogin(_ sender: LoginViewController) // to pass data
    func didLogin()
}
...
extension LoginViewController {
    private func style() {
        // This is what takes any control or element of view in your view controller and makes it ready for autolayout -> .translatesAutoresizingMaskIntoConstraints = false
    ...
    private func layout() {
        ...
        NSLayoutConstraint.activate([
            ...
            titleLabel.centerXAnchor.constraint(equalTo: loginView.trailingAnchor)
        ])
